...
public class PlannedActivityDTO {
    ...
    public PlannedActivityDTO(int id, int employee_id, int course_instance_id, String study_period,
        int planned_hours, int allocated_hours, int tActivity_id, double factor){
    ...
    public String getStudyPeriod(){return study_period;}
